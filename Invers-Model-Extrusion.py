...
def preprocess_data(input_data):
    ...
    Stellgroeßen = input_data[['T 1 [C]  (0,0 mm)', 'T 2 [C]  (10,0 mm)', 'T 3 [C]  (20,0 mm)', 'T 4 [C]  (30,0 mm)',
...
def main():
    ...
    early_stopping = EarlyStopping(monitor='val_loss', patience=200, resto-re_best_weights=True) 
